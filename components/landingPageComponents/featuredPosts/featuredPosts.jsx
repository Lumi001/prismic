    ...
    return (
        <div className={styles1.featured_posts}>
            ...
            <section className={styles.posts}>
                {items.map(card => <ProjectCard key={Math.random()} title={card.title[0].text} content={card.post_content[0].text.substring(0, 100)} href="/" link={card.link_text||"Learn More"}
