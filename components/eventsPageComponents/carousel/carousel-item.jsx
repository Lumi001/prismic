      ...
      <div className="carousel">
        <div className="carousel-text">
          ...
          <div className="location">
            <div className="locationlogo">
              ...
              >
                <path
                  d="M33.4484 33.69C37.0884 30.0481 39.1331 25.1098 39.1331 19.9608C39.1331 14.8118 37.0884 9.87351 33.4484 6.23165C31.6466 4.42866 29.5072 2.99838 27.1525 2.02254C24.7977 1.0467 22.2737 0.544434 19.7248 0.544434C17.1758 0.544434 14.6518 1.0467 12.2971 2.02254C9.9423 2.99838 7.80291 4.42866 6.00113 6.23165C2.36116 9.87351 0.316406 14.8118 0.316406 19.9608C0.316406 25.1098 2.36116 30.0481 6.00113 33.69L10.218 37.8459L15.8821 43.3492L16.2509 43.6763C18.3995 45.4174 21.5463 45.3065 23.5701 43.3492L30.3211 36.7785L33.4484 33.69ZM19.7248 28.2698C17.5189 28.2698 15.4033 27.3936 13.8435 25.8337C12.2837 24.2739 11.4074 22.1584 11.4074 19.9525C11.4074 17.7466 12.2837 15.6311 13.8435 14.0712C15.4033 12.5114 17.5189 11.6352 19.7248 11.6352C21.9307 11.6352 24.0462 12.5114 25.606 14.0712C27.1658 15.6311 28.0421 17.7466 28.0421 19.9525C28.0421 22.1584 27.1658 24.2739 25.606 25.8337C24.0462 27.3936 21.9307 28.2698 19.7248 28.2698Z"
                  fill="#FFC017"
                />
              </svg>
            </div>
        ...
        <div className="video-container">
          <video id="vid" onEnded={end} ref={video}>
            <source
              src="https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/BigBuckBunny.mp4#t=3"
              type="video/mp4"
            />
          </video>
          <div ref={playCaption} className="caption" onClick={play}>
            ...
            >
              <path
                d="M44.5 24.268C45.8333 25.0378 45.8333 26.9623 44.5 27.7321L3.25001 51.5478C1.91667 52.3175 0.250001 51.3553 0.250001 49.8157L0.250003 2.1843C0.250004 0.644698 1.91667 -0.317552 3.25 0.452249L44.5 24.268Z"
                fill="#F0F0F0"
              />
            </svg>
          </div>
